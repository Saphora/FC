...
(function (FC) {
    ...
    (function (Core) {
        ...
        var Environment = (function () {
            ...
            Environment.RemoteBaseURL = "http://festival-calendar.nl:8888";
            Environment.GeoServicesURL = "http://wmdevelopment.nl:8080";
            Environment.MediaURLRoot = "http://localhost:8888";
                ...
                BaseController.prototype.ExplodeTagString = function ($sce, tagString) {
                    ...
                    if (tagString) {
                        ...
                        array.forEach(function (v, i) {
                            tpl += '<li class="taglist-item"> ' + v.trim() + '</li>';
                        });
                        tpl += '</ul>';
        ...
        (function (Artists) {
            ...
            (function (Controllers) {
                var ArtistModalController = (function (_super) {
                    ...
                    function ArtistModalController($http, $q, $mdDialog, $scope, $route, $routeParams, $location, ThemingService, LocalizationService, UrlManagerService, $sce, GenreService, ArtistsService, local) {
                        _super.call(this, $http, $q, $scope, $location, $routeParams, $mdDialog);
        ...
        (function (Genres) {
            ...
            (function (Controllers) {
                var GenreFilterController = (function (_super) {
                    ...
                    GenreFilterController.prototype.ToggleGenre = function ($scope, genre) {
                        $scope = $scope.inst.$scope;
                        var any = false;
                        var modified = false;
                    ...
                    GenreFilterController.prototype.Save = function ($scope) {
                        var vm = this;
                        vm.Close($scope);
                        //vm.$scope.IsLoading = true;
                    };
                    GenreFilterController.prototype.Close = function ($scope) {
                        $("#GenreFilterControl").removeClass("ctx-visible").addClass("ctx-hidden");
                        $("#MainOverlay").removeClass('ctx-visible').addClass('ctx-hidden');
                    };
                    GenreFilterController.prototype.Reset = function ($scope) {
        ...
        (function (Theming) {
            ...
            (function (Services) {
                var ThemingService = (function (_super) {
                    ...
                    ThemingService.prototype.GetList = function () {
                        return this.Get('/API/Theme/GetList');
                    };
